                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material">
                            <div class="text-center">
                                <img src="https://contino.com.mx/contenido_demo/uploads/2020/03/logocontiweb.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Nombre De Usuario <label style="color: red">*</label></label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="password" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Contraseña <label style="color: red">*</label></label>
                                    </div>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <a href="Panel"><button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Iniciar Sesión</button></a>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="index.html"><b></b></a></p>
                                        </div>
                                        <div class="col-md-2">
